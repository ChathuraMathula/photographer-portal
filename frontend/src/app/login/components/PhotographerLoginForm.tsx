...
import { Eye, EyeOff, ShieldX, Camera, User, ShieldCheck, ArrowRight } from "lucide-react";
...
export function PhotographerLoginForm() {
    ...
    <div className="space-y-6">
      <div className="space-y-2 text-center md:text-left">
        ...
        <h1 className="text-title-large text-primary-dark dark:text-white leading-tight">
          Photographer Portal Sign In
        </h1>
        <p className="text-body-small text-zinc-500 dark:text-zinc-400">
          Manage reservations, proposals, availability, and chat with customers.
        </p>
      </div>
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-5">
        ...
        >
          {formik.isSubmitting ? "Signing in..." : "Photographer Login"}
        </Button>
      </form>
