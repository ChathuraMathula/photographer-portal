      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="md:col-span-2 space-y-6">
                ...
                <Card className="border border-zinc-200/50 shadow-sm rounded-xl overflow-hidden bg-white dark:bg-zinc-900">
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                      Your deposit was paid successfully. Please settle the
            ...
            {reservation.status === "CONFIRMED" &&
              (reservation.totalPaidInCents ?? 0) >=
                (reservation.totalAmountInCents ?? 1) && (
                <Card className="border border-green-200/50 shadow-sm rounded-xl overflow-hidden bg-green-50/10 dark:bg-green-950/10">
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">
                      All payments for this reservation are completed. You can
                      download your official system-generated invoice below.
                    </CardDescription>
                  </CardHeader>
                  <CardFooter>
                    <a
              ...
              onConfirm={() => {
                const depositAmt = () => {
                  ...
                  if (pkg.depositType === "percentage") {
                    return Math.round(
                      (pkg.priceInCents * (pkg.depositValue ?? 0)) / 100,
                    );
                  }
                  return 0;
                };
