...
export default function CustomerDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      ...
      <header className="sticky top-0 z-30 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 bg-[#0e2d5c] text-white rounded-xl flex items-center justify-center font-black text-sm">
            CP
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="h-8 px-3 text-xs gap-1.5 border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800"
          >
      ...
      <main className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <Card className="border-zinc-200/60 dark:border-zinc-800/80 shadow-sm bg-white dark:bg-zinc-900 overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-500">
                  Track your booked photography sessions, check proposals, and communicate with photographers.
                </p>
              </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-bold text-zinc-900 dark:text-white flex items-center gap-2">
              ...
              My Bookings & Reservations ({reservations.length})
            </h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {reservations.map((res) => (
                <Card
                  key={res.id}
                  className="border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 shadow-sm bg-white dark:bg-zinc-900 transition-all"
                >
                  ...
                  <CardContent className="space-y-3 text-xs">
                    ...
                    <div className="pt-2">
                      <Link
                        ...
                        target="_blank"
                        className="w-full inline-flex items-center justify-center gap-1.5 h-9 rounded-lg bg-[#0e2d5c] hover:bg-[#0b244a] text-white font-bold text-xs transition-all shadow-xs"
                      >
                        Track Booking & Chat
