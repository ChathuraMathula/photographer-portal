...
export function AuthorizationGate({
  ...
  return (
    <CardLayout
      title="Authorization Gate (Quick Log-In)"
      desc="Select a seeded role to automatically login and write session cookies."
    >
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        {SEED_ACCOUNTS.map((acc, i) => (
          ...
          >
            ...
            <span className="text-body-caption text-zinc-405 mt-2 truncate max-w-full font-semibold">
              {acc.name}
            </span>
          </button>
        ))}
        ...
        >
          <div className="sm:col-span-5 space-y-1.5">
            <Label
              ...
              className="text-body-caption text-zinc-500"
            >
              Email address
            </Label>
            <Input
