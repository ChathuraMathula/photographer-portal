...
export const ENDPOINTS: Endpoint[] = [
  // ── Auth & Health ────────────────────────────────────────────────────────────
  {
    method: "GET",
    path: "/health",
    description: "Fetch health status of the backend systems (database + server).",
    access: "Public",
  ...
  // ── Public Bookings ──────────────────────────────────────────────────────────
  {
    ...
    description: "Get public photographer bio, location, & specialties for the booking page.",
    access: "Public",
  ...
  },
  {
    ...
    description: "Check if a photographer slot is open for a given date and time range.",
    access: "Public",
    category: "Public Bookings",
    defaultQuery: [
  ...
  },
  {
    ...
    description: "Verify client email against the booking tracking token to grant tracking page access.",
    access: "Public",
    category: "Public Bookings",
  ...
  },
  {
    ...
    description: "Get message/chat negotiation logs for the customer tracking view.",
    access: "Public",
    category: "Public Bookings",
    defaultQuery: [{ key: "email", value: "priya@example.com" }]
  },
  {
    method: "POST",
    path: "/bookings/track/INSERT_TRACKING_TOKEN_HERE/messages",
    description: "Send a chat reply message as the customer from the tracking page.",
    access: "Public",
    category: "Public Bookings",
    defaultBody: JSON.stringify({
  ...
  },
  {
    ...
    description: "Toggle whether the photographer is accepting new client inquiries.",
    access: "Super Admin & Photographer",
    category: "Photographer Profile"
  },
  {
    ...
    description: "Retrieve the generated booking URL slug details for a photographer.",
    access: "Super Admin Only",
    category: "Photographer Profile"
  },
  ...
  // ── Packages ─────────────────────────────────────────────────────────────────
  {
    method: "GET",
    path: "/packages",
    description: "List all pricing package templates owned by the logged-in photographer.",
  ...
  },
  {
    method: "POST",
    path: "/reservations",
    description: "Manually create an offline reservation (e.g. booked over the phone).",
    access: "Photographer Only",
    category: "Reservations",
    defaultBody: JSON.stringify({
      firstName: "Nimal",
  ...
  },
  {
    ...
    description: "Submit a package proposal to the customer and lock the slot for 24 hours.",
    access: "Photographer Only",
    category: "Reservations",
    defaultBody: JSON.stringify({
  ...
  },
  {
    method: "POST",
    path: "/reservations/INSERT_RESERVATION_ID_HERE/messages",
    description: "Send a negotiation message to the customer as the photographer.",
    access: "Photographer Only",
    category: "Reservations",
    defaultBody: JSON.stringify({
  ...
  // ── Payments ─────────────────────────────────────────────────────────────────
  {
    ...
    description: "Process a payment charge (sandbox). Used by the tracking page deposit/balance flow.",
    access: "Public",
    category: "Payments",
    defaultBody: JSON.stringify({
  ...
  },
  {
    ...
    description: "Manually mark a confirmed reservation's full payment as fulfilled (cash in hand).",
    access: "Photographer Only",
    category: "Payments"
  },
  {
    ...
    description: "Retrieve all payment transaction records for the logged-in photographer.",
    access: "Photographer Only",
    category: "Payments"
  },
  {
  ...
  // ── Invoices ─────────────────────────────────────────────────────────────────
  {
    method: "GET",
    path: "/invoices",
    description: "List all invoices for the logged-in photographer across all completed reservations.",
    access: "Photographer Only",
    category: "Invoices"
  },
  {
    ...
    description: "Retrieve the photographer's invoice customization settings (logo, colors, notes).",
    access: "Photographer Only",
    category: "Invoices"
  },
  {
    method: "PATCH",
    path: "/invoices/settings",
    description: "Update invoice customization settings (business name, logo, accent color, footer notes).",
    access: "Photographer Only",
    category: "Invoices",
    defaultBody: JSON.stringify({
  ...
  },
  {
    ...
    description: "Download the PDF invoice for a specific completed reservation.",
    access: "Photographer Only",
    category: "Invoices"
  },
  {
    ...
    description: "Public endpoint for customers to download their invoice via tracking token (no auth required).",
    access: "Public",
    category: "Invoices"
  },
  {
  ...
  },
  {
    method: "POST",
    path: "/users",
    description: "Create a new system user account (Admin or Photographer role).",
    access: "Super Admin & Admin",
    category: "Users",
    defaultBody: JSON.stringify({
      firstName: "Kamal",
  ...
  },
  {
    ...
    description: "Toggle the active state (suspend or re-activate) of a user account.",
    access: "Super Admin & Admin",
    category: "Users"
  }
];
