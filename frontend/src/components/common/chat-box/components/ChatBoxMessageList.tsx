          ...
          return (
            <div key={msg.id} className="space-y-2">
              ...
              >
                ...
                <div
                  className={`rounded-xl px-3 py-1.5 text-body-caption shadow-sm ${isMe ? "bg-zinc-950 text-white dark:bg-white dark:text-zinc-950" : "bg-white text-zinc-900 border dark:bg-zinc-900 dark:text-zinc-100"}`}
                >
