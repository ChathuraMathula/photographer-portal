...
import { ReservationsLeftPane } from "./components/ReservationsLeftPane";
import { ReservationsRightPane } from "./components/ReservationsRightPane";
import { type ReservationsTabContentProps } from "./types";
