    ...
    <Card className="border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm rounded-xl overflow-hidden">
      <CardHeader className="pb-3 border-b border-zinc-100 dark:border-zinc-855 bg-zinc-50/20">
        ...
        <CardDescription className="text-body-caption text-zinc-500 mt-1">
          Configure a default deposit amount (fixed LKR or percentage of total
          package price) used when sending proposals.
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                onUniversalDepositValueChange(Number(e.target.value))
              }
              placeholder={
                universalDepositType === "fixed" ? "e.g. 5000" : "e.g. 10"
              }
