  ...
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-zinc-50/50 dark:bg-zinc-950/20 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800/50">
        <div>
          <Label className="text-body-caption font-semibold text-zinc-400">
            Account Email
          </Label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            className={`h-11 rounded-xl dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 focus:ring-primary-dark ${formik.touched.firstName && formik.errors.firstName ? "border-red-500" : ""}`}
          />
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={`h-11 rounded-xl dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 focus:ring-primary-dark ${formik.touched.lastName && formik.errors.lastName ? "border-red-500" : ""}`}
          />
      ...
      <div className="space-y-2">
        <Label
          htmlFor="phone"
          className="text-body-small-s font-semibold text-zinc-700 dark:text-zinc-300 flex items-center gap-1.5"
        >
      ...
      <div className="border-t border-zinc-100 dark:border-zinc-800 pt-6 space-y-4">
        ...
        <p className="text-body-caption text-zinc-500 leading-normal">
          Leave these fields blank if you do not wish to change your current
          login password.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`h-11 pr-10 rounded-xl dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 focus:ring-primary-dark ${formik.touched.password && formik.errors.password ? "border-red-500" : ""}`}
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`h-11 pr-10 rounded-xl dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 focus:ring-primary-dark ${formik.touched.confirmPassword && formik.errors.confirmPassword ? "border-red-500" : ""}`}
                placeholder="••••••••"
              />
              <button
                type="button"
