...
} from "@/app/dashboard/reports/charts";
      ...
      <section className="grid gap-6 md:grid-cols-3 relative">
        ...
        <Card className="md:col-span-2 border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm rounded-xl min-h-[350px]">
          <CardHeader>
            ...
            <CardDescription className="text-xs">
              Timeline representation of cash logs &amp; card payouts
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm rounded-xl min-h-[350px]">
          <CardHeader>
            ...
            <CardDescription className="text-xs">
              Platform booking states conversion breakdown
            </CardDescription>
          </CardHeader>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <Card className="border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm rounded-xl">
          <CardHeader>
            ...
            <CardDescription className="text-xs">
              Aggregated package usage across the platform
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm rounded-xl">
          <CardHeader>
            ...
            <CardDescription className="text-xs">
              Breakdown of event types booked by customers
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3.5">
              {reportData.eventTypes.length === 0 ? (
                <p className="text-body-caption text-zinc-450 italic">
                ...
                reportData.eventTypes.map((et: any, i: number) => (
                  <div
                    key={i}
                    className="flex justify-between items-center bg-zinc-50/50 dark:bg-zinc-950/20 p-3 rounded-xl border border-zinc-150/40 dark:border-zinc-800/50"
                  >
                    <span className="text-body-small-s font-semibold text-zinc-700 dark:text-zinc-300">
                      {et.name}
                    </span>
