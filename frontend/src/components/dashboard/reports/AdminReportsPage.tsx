  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-300">
      <AdminReportsHeader
        ...
        handleDownloadFinancial={handleDownloadFinancial}
        downloadingBookings={downloadingBookings}
        handleDownloadBookings={handleDownloadBookings}
        downloadingLocation={downloadingLocation}
        handleDownloadLocation={handleDownloadLocation}
      />
      {reportData?.systemStats && (
        <AdminSystemStats stats={reportData.systemStats} />
      )}
      ...
      <AdminLeaderboard
        ...
        setSearch={setLeaderboardSearch}
      />
      {reportData && (
