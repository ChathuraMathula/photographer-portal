        ...
        <div className="space-y-6 animate-pulse mt-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="h-32 bg-zinc-100 dark:bg-zinc-800/50 rounded-xl"
              />
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 h-96 bg-zinc-100 dark:bg-zinc-800/50 rounded-xl" />
            <div className="h-96 bg-zinc-100 dark:bg-zinc-800/50 rounded-xl" />
          </div>
