...
export function ManualBookingLocationFields({
  ...
  const { geocodingStatus, handleCityDistrictSelect, handleCoordinatesChange, handleMapChange } =
    ...
    <>
      ...
      <div className="space-y-2">
        <Label htmlFor="mb-coordinates" className="text-body-small-s font-semibold text-zinc-700 dark:text-zinc-300">
          Coordinates <span className="text-zinc-400 font-normal">(optional)</span>
        </Label>
        <Input
          id="mb-coordinates"
      ...
      <div className="space-y-2">
        ...
        {formik.values.locationMapLink && (
          <p className="text-[10px] text-zinc-400 font-medium truncate mt-1">
            Generated Link: <span className="font-mono">{formik.values.locationMapLink}</span>
          </p>
        )}
      </div>
    </>
