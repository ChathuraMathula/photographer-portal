    ...
    <>
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          />
          <FieldError
            msg={formik.touched.price ? formik.errors.price : undefined}
          />
        </div>
        <div className="space-y-2">
          <Label
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(val: any) =>
                formik.setFieldValue("depositType", val)
              }
            >
              ...
              <SelectContent className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                <SelectItem value="universal" className="cursor-pointer">
          ...
          {formik.values.depositType !== "universal" && (
            <div className="space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
              <Label
                htmlFor="pkg-depositValue"
                className="text-body-small-s font-semibold text-zinc-700 dark:text-zinc-300"
              >
                {formik.values.depositType === "fixed"
                  ? "Deposit Value (LKR)"
                  : "Deposit Value (%)"}
              </Label>
              <Input
                ...
                min="0"
                max={
                  formik.values.depositType === "percentage" ? 100 : undefined
                }
              ...
              <FieldError
                msg={
                  formik.touched.depositValue
                    ? formik.errors.depositValue
                    : undefined
                }
              />
            </div>
