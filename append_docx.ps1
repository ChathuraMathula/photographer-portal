...
$target = "c:\My files\BIT - UOC (2025, 2026)\Source\photographer-portal\Dissertation_Photographer_Portal_Final_V7.docx"
...
$appB = Get-Content "C:\Users\chath\.gemini\antigravity-ide\brain\f5eaec2e-43bb-4d62-bda4-f66910cf57cc\appendix_b_user_manual.md" -Raw
