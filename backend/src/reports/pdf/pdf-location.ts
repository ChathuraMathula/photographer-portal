...
export function buildLocationReportPdf(
  ...
  doc
    ...
    .fontSize(12)
    .font('Helvetica-Bold')
    .text('Geographic Coverage Summary', 50, 95);
  ...
  doc
    ...
    .fontSize(7)
    .font('Helvetica-Bold')
    .text('TOP DISTRICT', 60, 123);
  doc
    .fillColor(primaryColor)
    .fontSize(11)
    .font('Helvetica-Bold')
    .text(topDistrict, 60, 138, { width: 95 });
  ...
  doc
    ...
    .fontSize(7)
    .font('Helvetica-Bold')
    .text('TOP CITY', 180, 123);
  doc
    .fillColor(accentColor)
    .fontSize(11)
    .font('Helvetica-Bold')
    .text(topCity, 180, 138, { width: 95 });
  ...
  doc
    ...
    .fontSize(7)
    .font('Helvetica-Bold')
    .text('EXACT COORDINATES', 300, 123);
  doc
    .fillColor('#10b981')
    .fontSize(12)
    .font('Helvetica-Bold')
    .text(`${withCoords} bookings`, 300, 138);
  ...
  doc
    ...
    .fontSize(8.5)
    .font('Helvetica-Bold')
    .text('District', 60, y + 5)
    .text('Bookings Count', 400, y + 5);
  y += 18;
  ...
  if (sortedDistricts.length === 0) {
    ...
    doc
      ...
      .text('No district data recorded.', 60, y + 5);
    y += 18;
  }
  ...
  if (sortedCities.length === 0) {
    ...
    doc
      ...
      .fontSize(8.5)
      .font('Helvetica-Oblique')
      .text('No city data recorded.', 60, y + 5);
    y += 18;
  }
  ...
  doc
    ...
    .fontSize(12)
    .font('Helvetica-Bold')
    .text('Historical Locations Record', 50, y);
  y += 20;
  ...
  bookings.slice(0, 20).forEach((b: any, idx: number) => {
    ...
    doc
      ...
      .fontSize(7.5)
      .font('Helvetica')
      .text(b.clientName || 'Manual Client', 60, y + 5, {
        width: 110,
        ellipsis: true,
      })
