...
async function generateReport() {
    try {
        ...
        // Outputting to V3 to bypass the file lock if V2/Final is open in MS Word
        const outputPath = path.join(__dirname, '..', '..', 'Dissertation_Photographer_Portal_Final_V2.docx');
